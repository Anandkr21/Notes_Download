...
public class JavaInterviewProgramsNotes {
    ...
    public JavaInterviewProgramsNotes(WebDriver driver) {
        this.driver = driver;
    ...
    // Java Important Interview Programs card
    private By javaInterviewProgramsCard =
            By.xpath(
                    "//div[contains(@class,'note-list-card')]" +
                            "[.//h4[normalize-space()='Java Important Interview Programs']]"
            );

    // Preview button
    private By javaInterviewProgramsButton =
            By.cssSelector(
                    "button[aria-label='Preview Java Important Interview Programs']"
            );
    ...
    // =========================================================
    // OPEN JAVA IMPORTANT INTERVIEW PROGRAMS
    // =========================================================

    public void clickJavaImportantInterviewPrograms() {

        // Find Java Important Interview Programs card
        WebElement card =
                wait.until(
        ...
        System.out.println(
                "Java Important Interview Programs preview opened successfully."
        );
    }
    ...
    public void downloadAllJavaInterviewProgramsPages() {
        ...
        String downloadFolder =
                "downloaded-notes/Java-Important-Interview-Programs";
        ...
        while (true) {
            ...
            try {
                ...
                String filePath =
                        downloadFolder +
                                "/Java-Important-Interview-Programs-Page-" +
                                currentPage +
                                ".png";
